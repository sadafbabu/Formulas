...
const chapterList: Omit<ChapterMeta, 'formulaCount' | 'isReady'>[] = [
  ...
  { id: 'surface-chemistry', slug: 'surface-chemistry', name: 'Surface Chemistry', nameBn: 'পৃষ্ঠ রসায়ন', subjectId: 'chemistry', paperId: '2nd-paper', order: 9 },
  ...
  { id: 'vector-algebra', slug: 'vector-algebra', name: 'Vector Algebra', nameBn: 'ভেক্টর বীজগণিত', subjectId: 'math', paperId: '1st-paper', order: 2 },
  { id: 'matrix-determinant', slug: 'matrix-determinant', name: 'Matrices & Determinants', nameBn: 'ম্যাট্রিক্স ও নির্ণায়ক', subjectId: 'math', paperId: '1st-paper', order: 3 },
  { id: 'straight-lines', slug: 'straight-lines', name: 'Straight Lines', nameBn: 'সরলরেখা', subjectId: 'math', paperId: '1st-paper', order: 4 },
  { id: 'circle-geometry', slug: 'circle-geometry', name: 'Circle', nameBn: 'বৃত্ত', subjectId: 'math', paperId: '1st-paper', order: 5 },
  { id: 'sequences-series', slug: 'sequences-series', name: 'Sequences & Series', nameBn: 'অনুক্রম ও ধারা', subjectId: 'math', paperId: '1st-paper', order: 6 },
  { id: 'logarithms-exponents', slug: 'logarithms-exponents', name: 'Logarithms & Exponents', nameBn: 'লগারিদম ও ঘাত', subjectId: 'math', paperId: '1st-paper', order: 7 },
